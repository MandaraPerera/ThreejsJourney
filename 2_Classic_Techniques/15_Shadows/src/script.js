...
const ambientLightTweaks = lightTweaks.addFolder('AmbientLight')
ambientLightTweaks.add(ambientLight, 'intensity').min(0).max(3).step(0.001)

const directionalLightTweaks = lightTweaks.addFolder('DirectionalLight')
...
const cameraHelperTweaks = gui.addFolder('CameraHelpers')
cameraHelperTweaks.add(directionalLightCameraHelper, 'visible').name('directional.visible')
cameraHelperTweaks.add(spotLightCameraHelper, 'visible').name('spot.visible')
cameraHelperTweaks.add(pointLightCameraHelper, 'visible').name('point.visible')
