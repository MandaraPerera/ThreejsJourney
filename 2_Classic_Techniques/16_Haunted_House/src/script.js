...
// Wall
const wallColorTexture = textureLoader.load('./wall/wood_trunk_wall_1k/wood_trunk_wall_diff_1k.webp')
const wallARMTexture = textureLoader.load('./wall/wood_trunk_wall_1k/wood_trunk_wall_arm_1k.webp')
const wallNormalTexture = textureLoader.load('./wall/wood_trunk_wall_1k/wood_trunk_wall_nor_gl_1k.webp')
...
// Roof
const roofColorTexture = textureLoader.load('./roof/riet_01_1k/riet_01_diff_1k.webp')
const roofARMTexture = textureLoader.load('./roof/riet_01_1k/riet_01_arm_1k.webp')
const roofNormalTexture = textureLoader.load('./roof/riet_01_1k/riet_01_nor_gl_1k.webp')
...
const tick = () => {
    ...
    // Update controls
    controls.update()
    controls.autoRotateSpeed = autoRotateSpeed * timer.getDelta() * 60
 ...
 */
const gui = new GUI()
gui.add(controls, 'autoRotate').name('Auto Rotate Camera')